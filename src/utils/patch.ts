 ...
 * @version 1.1.3
 * Fork from https://github.com/microsoft/rushstack/blob/main/eslint/eslint-patch/src/modern-module-resolution.ts
 */
...
const currentPkgs = require(path.join(__dirname, '../../package.json'))
const currentDeps = Object.keys(currentPkgs.dependencies)
const getRequireFrom = (moduleName: string) =>
  currentDeps.includes(moduleName) && __filename
      ...
      try {
        ModuleResolver.resolve = function (
          ...
          return originalResolve.call(
            this,
            moduleName,
            getRequireFrom(moduleName) || importerPath
          )
        }
      ...
      try {
        ModuleResolver.resolve = function (
          ...
          return originalResolve.call(
            this,
            moduleName,
            getRequireFrom(moduleName) || ctx.filePath
          )
        }
        return originalLoadPlugin.apply(this, arguments)
      } finally {
